...
def run_query(query):
    ...
    Do not append 'SQL: Here is the SQL query ' to SQLQuery.
    ...
    {table_info}
    If someone asks for the payment, they really mean the payment_dataset table.
    If someone asks for the payment rail, they really mean the column payment_dataset.paymentmethod.
...
query = """How many number of payments?"""
query = """How many payments have payment method rtp and sender name Alex?"""
...
query = """Please provide daily payments count for last 5 days?"""
